            ...
            <div class="col-sm-12">
                <div class="panel" style="padding: 10px">
                    ...
                    <div class="panel-body">
                        <form action="{{route('sphere.update' ,['id'=>$sphere->id])}}" method="post">
                            <div class="form-group">
                                <label for="name">Имя</label>
                                <input type="text" value="{{$sphere->name}}" name="name" class="form-control" placeholder="Наименование" required>
                            </div>
                            {{csrf_field()}}
                            <div class="form-group">
